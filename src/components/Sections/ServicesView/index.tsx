...
const servicesData = [
    ...
    },
    {
        ...
        "logo": "table",
        "title": "Data Science",
        "description": "Perform data analysis, extract insightful information from the given datasets and apply it in various applications."
    }
];
...
const ServicesView = () => {
    return(
        <div className="services-view-container">
            ...
            <div className="services-view-description">Different tools and skills to help you understand me better.</div>
